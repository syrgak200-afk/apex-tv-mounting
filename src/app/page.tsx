...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      ...
      <div className={`mobile-menu ${menuOpen ? "is-open" : ""}`} id="mobile-menu"><a href="#services" onClick={closeMenu}>Services</a><a href="#process" onClick={closeMenu}>Our process</a><a href="#gallery" onClick={closeMenu}>Gallery</a><a href="#quote" onClick={closeMenu}>Get a quote</a><a href={phoneHref} onClick={closeMenu}>Call {phoneDisplay}</a></div>
